...
Seed these as `inbox` or `next` items when the user asks to initialize the radar.
...
- ✅ 三版本命名体系：personal- (个人), team- (团队 GitLab), public- (公开 GitHub)
- ✅ 改名：old-skill-name → praxis-skill-forge
...
```
| daily-news | 每日新闻与监控 skill 改造 | praxis-github-watchtower, praxis-agent-reach-ops, praxis-news-aggregator, praxis-youtube-clipper, project-intake |
| ai-os | AI OS 改造 | your-project, deerflow, tauri, OpenHarness, fay, openapi, IBM cuga, Omnigent, everOs, ollama/ollama |
| knowledge-base | 知识库改造 | awesome-architecture |
