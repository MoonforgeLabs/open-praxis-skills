...
MAINLINES = {
    ...
    "ai-os": {
        "title": "个人 AI OS 改造",
        "description": "Moonforge 和个人 AI OS",
        "priority": "P0",
        "status": "进行中",
        "next_steps": [
        ...
        "dependencies": ["moonforge", "deerflow", "tauri", "OpenHarness", "fay", "openapi", "IBM cuga", "Omnigent", "everOs", "ollama/ollama"],
        "competitors": [],
        "references": []
    },
    "rag-docs": {
    ...
    "daily-news": {
        ...
        "dependencies": ["praxis-github-watchtower", "praxis-agent-reach-ops", "praxis-news-aggregator", "praxis-youtube-clipper", "moonforge-intake"],
        "competitors": [],
        "references": []
    },
    "knowledge-base": {
